...
export default function AssinaturaPage() {
  ...
  const isMedical = subscription?.plan === "MEDICAL";

  const checkout = useMemo(() => {
    const business = !isMedical && (subscription?.plan === "BUSINESS" || profile?.role === "INSTITUTIONAL");
      ...
      <section className="mx-auto max-w-5xl px-4 py-12 md:px-8">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_.8fr]">
          ...
          <Card className="border-0 bg-[#0b1020] text-white shadow-2xl shadow-indigo-200">
            ...
            <CardContent>
              {active ? (
                <Link href={isMedical ? "/medicos/dashboard" : "/dashboard"}>
