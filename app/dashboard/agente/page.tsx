    ...
    <div className="space-y-7">
      <section className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">Converse com seus próprios dados, consulte sua situação e proponha lançamentos em linguagem natural.</p>
        </div>
      ...
      <section className="grid gap-3 md:grid-cols-3">
        ...
        <Info icon={ShieldCheck} title="Você confirma as ações" text="Consultas são livres. Qualquer lançamento precisa da sua confirmação antes de ser gravado." />
        <Info icon={Sparkles} title="Linguagem natural" text="Pergunte como falaria com uma pessoa ou descreva uma receita ou despesa normalmente." />
      </section>
