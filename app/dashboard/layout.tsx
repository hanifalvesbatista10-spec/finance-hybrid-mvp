...
import {BarChart3,BellRing,BrainCircuit,Building2,CalendarClock,CalendarDays,ChevronDown,CreditCard,FileText,FolderTree,Goal,Landmark,LayoutDashboard,LogOut,Menu,ReceiptText,ShieldAlert,ShieldCheck,Upload,UserRound,X} from "lucide-react";
...
const personal:Item[]=[{label:'Visão Geral',href:'/dashboard',icon:LayoutDashboard},{label:'Meu Agente Financeiro',href:'/dashboard/agente',icon:BrainCircuit},{label:'Contas Financeiras',href:'/dashboard/contas-financeiras',icon:Landmark},{label:'Cartões e Faturas',href:'/dashboard/cartoes',icon:CreditCard},{label:'Lançamentos',href:'/dashboard/lancamentos',icon:ReceiptText},{label:'Categorias',href:'/dashboard/categorias',icon:FolderTree},{label:'Importações',href:'/dashboard/importacoes',icon:Upload},{label:'Contas e Alertas',href:'/dashboard/contas',icon:BellRing},{label:'Fixos mensais',href:'/dashboard/recorrencias',icon:CalendarClock},{label:'Calendário',href:'/dashboard/calendario',icon:CalendarDays},{label:'Relatórios',href:'/dashboard/relatorios',icon:FileText},{label:'Metas',href:'/dashboard/metas',icon:Goal}];
const business:Item[]=[{label:'Fluxo de Caixa',href:'/dashboard',icon:BarChart3},{label:'Meu Agente Financeiro',href:'/dashboard/agente',icon:BrainCircuit},{label:'Contas Financeiras',href:'/dashboard/contas-financeiras',icon:Landmark},{label:'Cartões e Faturas',href:'/dashboard/cartoes',icon:CreditCard},{label:'Lançamentos',href:'/dashboard/lancamentos',icon:ReceiptText},{label:'Categorias',href:'/dashboard/categorias',icon:FolderTree},{label:'Importações',href:'/dashboard/importacoes',icon:Upload},{label:'Contas e Alertas',href:'/dashboard/contas',icon:BellRing},{label:'Fixos mensais',href:'/dashboard/recorrencias',icon:CalendarClock},{label:'Calendário',href:'/dashboard/calendario',icon:CalendarDays},{label:'Relatórios',href:'/dashboard/relatorios',icon:FileText},{label:'Centros de Custo',href:'/dashboard/centros-de-custo',icon:Building2},{label:'Permissões',href:'/dashboard/permissoes',icon:ShieldCheck}];
