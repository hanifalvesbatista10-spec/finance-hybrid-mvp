      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-14 md:px-8 md:py-20 lg:grid-cols-[1.02fr_.98fr] lg:items-center">
        <div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <a href="#ecossistema"><Button variant="outline" className="h-14 rounded-2xl border-black/10 bg-white px-7 text-base font-bold">Ver o ecossistema</Button></a>
          </div>
